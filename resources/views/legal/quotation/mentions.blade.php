<div class="mentions">
    ...
    <ul>
        ...
        <li>En cas d’acceptation du devis puis de dédit, complet ou partiel, du client, ce dernier devra régler une quote-part de 20% des sommes
            correspondant aux prestations non encore réalisées.</li>
    </ul>
    <h2>En conformité de l’article L 441-6 du Code de commerce :</h2>
    <ul>
       <li>La facture correspondante sera payable sous 30 jours.</li>
       <li>Pas d’escompte pour paiement anticipé.</li>
       <li>Tout règlement effectué après expiration de ce délai donnera lieu, à titre de pénalité de retard, à l’application d’un intérêt égal à celui appliqué par
            la Banque Centrale Européenne à son opération de refinancement la plus récente, majoré de 10 points de pourcentage, ainsi qu'à une indemnité
            forfaitaire pour frais de recouvrement d'un montant de 40 Euros.</li>
       <li>Les pénalités de retard sont exigibles sans qu’un rappel soit nécessaire.</li>
    </ul>
    <h2>Informations concernant les droits d'exploitation :</h2>
    <ul>
